...
Namespace coordinador
    ...
    Partial Public Class coordinador
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.proyecto_HADS.My.MySettings.Default.proyecto_HADS_coordinador_coordinador
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/MediaAlumnos", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function MediaAlumnos(ByVal asig As String) As String
